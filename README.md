...
> **2026-08-13 - Backup provenance fidelity:** Database snapshot restores now preserve Analytics, mapping, Meta, and campaign administrator provenance whenever the referenced administrator exists. Incomplete historical snapshots remain restorable through explicit sanitized missing-actor warnings, self-referential links still use ordered two-pass restoration, and the protected disposable verifier restores snapshot administrators before enforcing the unchanged frozen Game Over fingerprints.
