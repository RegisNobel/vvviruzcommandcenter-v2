...
const fieldAliases: Record<string, keyof ParsedMetaAdRow> = {
  ...
  reach: "reach",
  frequency: "frequency",
  cost_per_1_000_meta_accounts_reached_usd: "cost_per_thousand_accounts_reached",
  cpm_cost_per_1_000_impressions_usd: "cpm",
  results: "results",
  ...
  cpc_cost_per_link_click_usd: "cpc",
  ctr: "ctr",
  ...
  cost_per_landing_page_view_usd: "cost_per_landing_page_view",
  ...
  "2_second_continuous_video_plays": "two_second_continuous_plays",
  cost_per_2_second_continuous_video_play_usd: "cost_per_two_second_continuous_play",
  "3_second_video_plays": "three_second_plays",
  three_second_video_plays: "three_second_plays",
  cost_per_3_second_video_play_usd: "cost_per_three_second_play",
  thruplays: "thru_plays",
  thru_play: "thru_plays",
  thru_plays: "thru_plays",
  cost_per_thruplay: "cost_per_thru_play",
  cost_per_thruplay_usd: "cost_per_thru_play",
...
const numericFields = new Set<keyof ParsedMetaAdRow>([
  ...
  "instagram_follows",
  "video_plays",
  "two_second_continuous_plays",
  "cost_per_two_second_continuous_play",
  "three_second_plays",
  "cost_per_three_second_play",
  "thru_plays",
  "cost_per_thru_play",
  "video_25",
  "video_50",
...
const videoViewHeaders = new Set([
  ...
  "cost_per_2_second_continuous_video_play_usd",
  "3_second_video_plays",
  "three_second_video_plays",
  "cost_per_3_second_video_play_usd",
  "thruplays",
  "thru_play",
  "thru_plays",
  "cost_per_thruplay",
...
const engagementViewHeaders = new Set([
  ...
  "cpc_all_usd",
  "landing_page_views",
  "cost_per_landing_page_view_usd",
  "shop_clicks",
  "page_engagement",
  "post_reactions",
  "post_comments",
...
const deliveryViewHeaders = new Set([
  ...
  "reach",
  "frequency",
  "cost_per_1_000_meta_accounts_reached_usd",
  "cpm_cost_per_1_000_impressions_usd",
  "results",
  "result_indicator",
  "cost_per_result",
  "cost_per_results",
...
function emptyRow(fileName: string, sourceView: MetaMetricView): ParsedMetaAdRow {
  return {
    ...
    reach: null,
    frequency: null,
    cost_per_thousand_accounts_reached: null,
    cpm: null,
    results: null,
    result_indicator: "",
    ...
    video_plays: null,
    two_second_continuous_plays: null,
    cost_per_two_second_continuous_play: null,
    three_second_plays: null,
    cost_per_three_second_play: null,
    thru_plays: null,
