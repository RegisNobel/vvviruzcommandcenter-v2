...
function createDefaultSiteContent(): SiteContentSettings {
  ...
  exclusive: {
    badge_text: "Vault Preview",
    headline: "Unlock the Vault Preview Pack.",
    subtext: "Join the list for early access to The Vault EP, off-platform tracks, glitch covers, lyric booklets, and direct-to-fan drops.",
    brand_line: "Direct-to-Fan Access",
    cta_label: "Join the Vault List",
    name_label: "Name",
    email_label: "Email",
    consent_label: "Send me future vvviruz updates and releases.",
    success_heading: "You’re on the Vault list.",
    success_message: "Watch your inbox for the first preview drop.",
    duplicate_message:
      "You’re already on the list. Watch your inbox for the next preview drop.",
    download_label: "Download the preview",
    unavailable_heading: "Vault Preview unavailable",
    unavailable_body:
      "The vault is closed right now. Check back soon for the next drop.",
